...
insert into privilege(id, name, description, pos) values('TEST_P', 'Test privilege', '', 0);
...
insert into privilege(id, name, description, pos) values('TEST_P2', 'Test privilege2', '', 0);
insert into privilege(id, name, description, pos) values('TEST_P3', 'Test privilege3', '', 0);
insert into privilege(id, name, description, pos) values('TEST_P4', 'Test privilege4', '', 0);
