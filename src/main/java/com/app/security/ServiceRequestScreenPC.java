...
public class ServiceRequestScreenPC implements PrivilegeChecker {
    @Override
    public Map<String, Boolean> getPrivileges() {
        ...
        userPA.put("editR", hasAnyPrivilegeAction(
                        new PrivilegeAction("serviceRequestEdit", "READ"))
        );
        userPA.put("editEx", hasAnyPrivilegeAction(
                        new PrivilegeAction("serviceRequestEdit", "EXECUTE"))
        );

        userPA.put("deleteR", hasAnyPrivilegeAction(
                        new PrivilegeAction("serviceRequestDelete", "READ"))
        );
        userPA.put("deleteEx", hasAnyPrivilegeAction(
                        new PrivilegeAction("serviceRequestDelete", "EXECUTE"))
        );
